...
public class GenUtils {
    ...
    public static List<String> getTemplates(){
        ...
        templates.add("template/FacadeImpl.java.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for(Map<String, String> column : columns){
            ...
            //列的数据类型，转换成Java类型
            String attrType = config.getString(columnEntity.getDataType(), "Object" ); //第一个值为空则取第二个
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.iuoon" : mainPath;
        //封装模板数据
